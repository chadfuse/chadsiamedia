<?php
/**
 * Single Case Study Content Template: Chad Sia Media Architecture Revamp
 *
...
:root {
  ...
  --cs-pill-text: #1d4ed8;
                ...
                <!-- Sub-pillar 2 -->
                <h3 class="cs-heading-3">2. Inlined Critical CSS & Non-Blocking Master Hydration</h3>
                <p>
    ...
    window.addEventListener('load', function() {
      setTimeout(hydrateHeroVideo, 600);
            ...
            <section class="cs-content-section" id="business-impact">
                ...
                <div class="cs-impact-grid">
                    <div class="cs-impact-card">
                        ...
                        <h4 class="cs-impact-title">100% Clean Codebase</h4>
                    ...
                    <div class="cs-impact-card">
                        <div class="cs-impact-icon">&check;</div>
                        <h4 class="cs-impact-title">Sub-Second Conversion Funnel</h4>
                    ...
                    <div class="cs-impact-card">
                        <div class="cs-impact-icon">&check;</div>
                        <h4 class="cs-impact-title">Zero Maintenance Friction</h4>
                    ...
                    <div class="cs-impact-card">
                        <div class="cs-impact-icon">&check;</div>
                        <h4 class="cs-impact-title">Search Engine Authority</h4>
            ...
            <nav class="cs-post-nav" aria-label="Case Study Navigation">
                ...
                <a href="<?php echo esc_url(home_url('/portfolio/#solarplus')); ?>" class="cs-post-nav-link cs-nav-next">
                    <span class="cs-nav-label">Next Project &rarr;</span>
                    <span class="cs-nav-title">SolarPlus Platform & Design Engine</span>
                </a>
            </nav>
